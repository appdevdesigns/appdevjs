// This is a jQuery plugin called `actual`, which calculates actual dimensions
// of elements. It is used by the widget below.
...
// This is the iOSCheckbox widget
(function() {
  ...
  iOSCheckbox = (function() {
    ...
    iOSCheckbox.prototype._getDimension = function(elem, dimension) {
      if ($.fn.actual != null) {
        // Use `actual` plugin method
        return elem.actual(dimension);
      } else {
        // Use native jQuery dimension methods
    ...
    iOSCheckbox.prototype.optionallyResize = function(mode) {
      ...
      /*
      // If element has not been added to the page yet, the widths will be zero
      if (onLabelWidth == 0) {
        onLabelWidth = parseInt(this.onLabel.length * 8);
      }
      if (offLabelWidth == 0) {
        offLabelWidth = parseInt(this.offLabel.length * 8);
      }
      */
      if (mode === "container") {
        // Container
    ...
    iOSCheckbox.prototype.refresh = function(triggerOnChange) {
      return this.didChange(triggerOnChange);
    };
    
    /**
     * @param {Boolean} triggerOnChange [optional] Default is TRUE.
     */
    iOSCheckbox.prototype.didChange = function(triggerOnChange) {
      var new_left;
