...
/**
 *  appRAD generated setup script for the ComponentManager Interface container. 
 *
 *  The job of this code is to make sure the HTML DOM content required
 *  for the siteComponentManager_setup() is generated before it is called.
 */
...
(function() {
    ...
    var siteComponentManagerRADSetup = function() {
        ...
        // place before the siteComponentManagerSetup() is called.
        ...
        $.when(initProcess).done(function () {
            ...
            // keep this last:
            // publish a notification it's time to run siteComponentManagerSetup()
            OpenAjax.hub.publish("ad.site.componentManager.setup", {});
    ...
    var subscriptionID = OpenAjax.hub.subscribe('ad.site.componentManager.radsetup',siteComponentManagerRADSetup);
